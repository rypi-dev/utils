...
const isModuleResolutionError: (ex: unknown) => boolean = (ex) =>
  typeof ex === 'object' && ex !== null && 'code' in ex && (ex as { code: unknown }).code === 'MODULE_NOT_FOUND'
...
export const ModuleResolver: ModuleResolver =
  eslintMajorVersion === 8 ? require(eslintrcBundlePath!).Legacy.ModuleResolver : require(moduleResolverPath!)
