...
function mapRuleEntry(ruleEntry: Linter.RuleEntry, mapper: MapLevel): Linter.RuleEntry {
...
function mapRules(rules: Partial<Linter.RulesRecord> | undefined = {}, mapper: MapLevel): Partial<Linter.RulesRecord> {
